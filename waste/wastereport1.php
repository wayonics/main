...
<center> <caption><h1>JYOTIRMAYE TEXTILES PVT. LTD.</caption><br />#11-12-12, RAMIREDDYPET, NARASARAOPET,GUNTUR D.T.</h1></center><br />
 <h2>DAY WISE WASTE STOCK QUANTITY REPORT  FROM <?php echo $dt1 ?> TO  <?php echo $dt2 ?> </h2>
...
onClick='$("#datatodisplay").val( $("<div>").append( $("#ReportTable").eq(0).clone() ).html() )'>
 ...
 <?php 
 include 'db.php'; 
 $q=mysql_query("SELECT * FROM `wastecotton` WHERE date  BETWEEN '$dt1' AND '$dt2'")or die(mysql_error());
