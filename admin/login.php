...
$b=$_POST['f2'];
 ...
 include 'db.php';
  ...
  $acc1=mysql_num_rows($acc);
    ...
    $wa=mysql_query("select * from register where firstname='$a' and password='$b' and moduletype='ACCOUNTS'");
  $wa1=mysql_num_rows($wa);
  
  
   $head=mysql_query("select * from register where firstname='$a' and password='$b' OR type='Managing Director' OR type='Vice Precident' OR type='Genaral Manager'");
