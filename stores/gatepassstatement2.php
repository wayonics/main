...
<center> <caption><h1>JYOTIRMAYE TEXTILES PVT. LTD.</caption><br />#11-12-12, RAMIREDDYPET, NARASARAOPET,GUNTUR D.T.</h1></center><br />
 <h2>statement for RETURNABLE MATERIAL SENT OUTSIDE FROM STORES ON <?php echo $dt1 ?>  </h2>
 ...
 */
 ...
 { 
 echo "<tr><td>$a[slno]<td>$a[date]<td>$a[gatepassno]<td>$a[companyname]<td>$a[itemname]<td> $a[rate]<td> $a[quantity]<td>$a[make]   ";
 }  
 echo "</tr>";
  /*
