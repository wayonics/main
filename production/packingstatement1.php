...
table
{
 ...
 $q2=mysql_query("SELECT sum(bagsstock) FROM  `packing` WHERE date  BETWEEN '$dt1' AND '$dt2'")or die(mysql_error());
 $q3=mysql_query("SELECT sum(conesstock) FROM  `packing` WHERE date  BETWEEN '$dt1' AND '$dt2'");
 ...
 $d=mysql_fetch_array($q3);
  ...
  echo "<tr> <td></td> <td> </td> <td> </td><td> </td> <td> $c</td> <td> $d</td> <td> $kg</td>  <td></td> <td> </td> <td> </td> <td> </td> <td> </td> <td> </td>  <td> $c</td> <td> $d</td> <td> $kg</td>  <td></td>";
