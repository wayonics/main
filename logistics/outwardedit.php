...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
     <?php 
	  ...
	  $q1=mysql_query(" SELECT * FROM `outward` WHERE  id='$id'");
	...
	echo "<font color=purple>"; echo date('l, jS F Y'); /* - h:i:s A */?></h2>
            <div class="one_quarter2  ">
			 ...
			 <form action="outwardedit1.php" method="post" enctype="multipart/form-data">
  ...
  <font color="#000066">DATE: <input type="date" name="f1"  >
			   ...
			   <font color="#000066">CUSTOMER NAME: <input type="text" name="f4" value="<?php echo $a[4] ?>"  >
             <font color="#000066">DC NO: <input type="text" name="f5" value="<?php echo $a[5] ?>"  >
                 ...
                 <font color="#000066">REMARKS: <input type="text" name="f7"  value="<?php echo $a[7] ?>" >
