...
<div class="wrapper row3">
      ...
      <!-- main body --> 
         ...
         <table bgcolor="white" align="center" class="cl" width="950px" height="" border="2">
             ...
             while($a=mysql_fetch_array($q))
				 ...
				 echo "<tr><td>$a[0]<td>$a[1]<td>$a[2]<td>$a[3]<td>$a[4]<td>$a[5]<td>$a[6]<td><a href='inwardedit.php?id=$a[id]'>EDIT&nbsp;&nbsp;&nbsp;&nbsp;<a href='inwarddelete.php?id=$a[id]'>DELETE</td>";
 ...
 <BR><BR><BR> <center><h1><b><font color="purple">OUTWARD DETAILS</font></b></h1>
          <table bgcolor="white" align="center" class="cl" width="950px" height="" border="2">
             ...
             while($a=mysql_fetch_array($q1))
				 ...
				 echo "<tr><td>$a[0]<td>$a[1]<td>$a[2]<td>$a[3]<td>$a[4]<td>$a[5]<td>$a[6]<td>$a[7]<td><a href='outwardedit.php?id=$a[id]'>EDIT&nbsp;&nbsp;&nbsp;&nbsp;<a href='outwarddelete.php?id=$a[id]'>DELETE</td>";
